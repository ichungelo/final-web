    ...
    <div class="col-lg-8">
      <div class="card mt-3">
        ...
        <div class="card-body">
          <form method="POST">
            <div class="form-row">
              <div class="behind-nav form-group col-12 text-center">
                <img class="private-style-avatar my-2" src="https://avatars.dicebear.com/api/initials/<?= $_SESSION['firstName'] ?>-<?= $_SESSION['lastName'] ?>.svg" alt="">
                <p class="text-center"><?= $_SESSION['username'] ?></p>
                <div class="form-group col-md-12">
                  <label for="accountDeletePassword">Enter your password :</label>
                  <input type="password" class="form-control form-control-sm" name="accountDeletePassword" minlength="8" required>
                </div>
              </div>
              <a href="profile.php" class="btn btn-primary ml-auto btn-block">Back to profile</a>
              <button type="submit" class="btn btn-danger ml-auto btn-block" name="accountDelete" onclick="return confirm('Are you REALLY sure you want to delete your account?')">Delete</button>
            </div>
          </form>
        </div>
      </div>
