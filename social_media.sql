...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2021 at 08:46 AM
...
CREATE TABLE `follows` (
  ...
  `follow_user_id` varchar(32) NOT NULL
...
ALTER TABLE `follows`
  ...
  ADD CONSTRAINT `follows_ibfk_2` FOREIGN KEY (`follow_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
